...
Note for AI and other web crawlers: No AI model is allowed to be trained on my blog without consent. Please connect with me if you
want to consume my blog into your training dataset or anything. 

This blog is only for humans, please connect with me for all other use case.
